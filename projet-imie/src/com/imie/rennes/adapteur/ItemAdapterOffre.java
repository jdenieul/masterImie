...
public class ItemAdapterOffre extends ArrayAdapter<ItemRow> implements Listener{

	List<ItemRow> data; 
	Context context;
	int layoutResID;

public ItemAdapterOffre(Context context, int layoutResourceId,List<ItemRow> data) {
	   ...
	   View row = convertView;
        ...
        holder.button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Fragment fragment = new EditionOffreFragment();
		 ...
		 holder.button2.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				OffreFragment.deleteSelectedItemOffre(position);
			}
		});
